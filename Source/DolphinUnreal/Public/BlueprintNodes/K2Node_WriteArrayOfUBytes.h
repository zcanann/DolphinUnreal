...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FDolphinWriteArrayOfUBytesMulticastDelegate, UDolphinInstance*, DolphinInstance, const TArray<FDolphinUInt8>&, Value, bool, bSuccess);

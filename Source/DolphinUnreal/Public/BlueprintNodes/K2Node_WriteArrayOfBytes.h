...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FDolphinWriteArrayOfBytesMulticastDelegate, UDolphinInstance*, DolphinInstance, const TArray<FDolphinInt8>&, Value, bool, bSuccess);

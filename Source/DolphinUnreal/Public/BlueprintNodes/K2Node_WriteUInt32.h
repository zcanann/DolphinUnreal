...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FDolphinWriteUInt32MulticastDelegate, UDolphinInstance*, DolphinInstance, FDolphinUInt32, Value, bool, bSuccess);

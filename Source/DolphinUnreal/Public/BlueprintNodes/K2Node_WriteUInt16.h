...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FDolphinWriteUInt16MulticastDelegate, UDolphinInstance*, DolphinInstance, FDolphinUInt16, Value, bool, bSuccess);
